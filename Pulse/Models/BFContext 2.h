...
extern NSString * const BFContextCampJoinWallPrivate;
//extern NSString * const BFContextCampJoinWallForm;
//extern NSString * const BFContextCampJoinWallPay;
//extern NSString * const BFContextCampJoinWallLocation;
...
@property (nonatomic) NSArray <Optional> *join;
...
// can the user approve new members
