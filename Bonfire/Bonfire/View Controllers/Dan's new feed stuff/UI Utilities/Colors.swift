...
extension UIColor {
    static var liveAudioTop: UIColor { UIColor(hex: "2E00FF")! }
    static var liveAudioBottom: UIColor { UIColor(hex: "F800FF")! }
    static var liveVideoTop: UIColor { UIColor(hex: "FF0000")! }
    static var liveVideoBottom: UIColor { UIColor(hex: "FF7F00")! }
    static var liveChatTop: UIColor { UIColor(hex: "64D923")! }
    static var liveChatBottom: UIColor { UIColor(hex: "00D3FF")! }
