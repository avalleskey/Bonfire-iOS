...
#import "BotFollowButton.h"
#import "Session.h"
#import "UIColor+Palette.h"

@implementation BotFollowButton

- (void)updateStatus:(NSString *)status {
    self.status = status;
    
    // set icon + title
    if ([status isEqualToString:USER_STATUS_BLOCKED] ||
        ...
        [self setTitle:@"Add to Camp" forState:UIControlStateNormal];
    }
