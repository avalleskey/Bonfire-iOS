...
NSString * const BFContextCampJoinWallPrivate = @"private";
//NSString * const BFContextCampJoinWallForm = @"form";
//NSString * const BFContextCampJoinWallPay = @"pay";
//NSString * const BFContextCampJoinWallLocation = @"location";
