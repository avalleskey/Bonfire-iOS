...
- (void)presentTipView:(BFTipView *)tipView completion:(void (^ __nullable)(void))completion {
    ...
    UINavigationController *activeNavVC = [[Launcher sharedInstance] activeNavigationController];
    UITabBarController *activeTabVC = [[Launcher sharedInstance] activeTabController];
    UIViewController *activeViewController = [[Launcher sharedInstance] activeViewController];
