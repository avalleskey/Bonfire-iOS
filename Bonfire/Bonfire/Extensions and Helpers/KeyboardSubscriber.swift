...
class UIKeyboardSubscribedViewController: UIViewController {
    ...
    func subscribeToKeyboard() {
        NotificationCenter.default.addObserver(self, selector: #selector(updateKeyboard(sender:)), name: UIResponder.keyboardWillShowNotification, object: nil);
        NotificationCenter.default.addObserver(self, selector: #selector(updateKeyboard(sender:)), name: UIResponder.keyboardWillHideNotification, object: nil);
    }
