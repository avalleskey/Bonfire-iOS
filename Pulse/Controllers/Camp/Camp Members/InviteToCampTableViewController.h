//
//  InviteToCampTableViewController.h
//  Pulse
//
...
@interface InviteToCampTableViewController : ThemedTableViewController <UITableViewDataSource, UITableViewDelegate, UITextFieldDelegate>
