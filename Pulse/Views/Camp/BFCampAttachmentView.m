...
// display name macros
#define CAMP_ATTACHMENT_DISPLAY_NAME_FONT [UIFont systemFontOfSize:22.f weight:UIFontWeightHeavy]
#define CAMP_ATTACHMENT_DISPLAY_NAME_BOTTOM_PADDING 4
// username macros
#define CAMP_ATTACHMENT_USERNAME_FONT [UIFont systemFontOfSize:16.f weight:UIFontWeightBold]
...
- (void)setup {
    ...
    self.headerBackdrop = [[UIView alloc] initWithFrame:CGRectMake(0, 0, self.frame.size.width, CAMP_ATTACHMENT_EDGE_INSETS.top + CAMP_ATTACHMENT_AVATAR_SIZE * .6)];
    self.headerBackdrop.backgroundColor = [UIColor bonfireOrange];
    [self.contentView addSubview:self.headerBackdrop];
    
    self.avatarContainerView = [[UIView alloc] initWithFrame:CGRectMake(self.frame.size.width / 2 - CAMP_ATTACHMENT_AVATAR_SIZE / 2 - 5, CAMP_ATTACHMENT_EDGE_INSETS.top - 5, CAMP_ATTACHMENT_AVATAR_SIZE + 10, CAMP_ATTACHMENT_AVATAR_SIZE + 10)];
    ...
    self.avatarView = [[BFAvatarView alloc] initWithFrame:CGRectMake(5, 5, CAMP_ATTACHMENT_AVATAR_SIZE, CAMP_ATTACHMENT_AVATAR_SIZE)];
